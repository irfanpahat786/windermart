   ...
   foreach ($res as $row)
    {
        ...
        if($counter == 0)
        {
			...
			<img src="assets/images/sliders/'.$image.'" alt="'.$title.'" style="height:280px; width:1349px;" />
				  ...
				  <div class="modal-content">
					...
					?>	
					  <div class="row top-text">
						  ...
						  <img src="offersimage/<?php echo $ak['image'];?>" alt="High Presssure Laminates (HPL) Suppliers and Exporter in India"    class="img-popup">
						  <div>
    ...
    <a class="right carousel-control" href="#myCarousel" data-slide="next">
      ...
      <span class="sr-only">Next</span>
					...
					<div class="slider slider-mar" >
						...
						<div>
							<a href="http://www.windermart.com/<?php echo $argk['url'];?>"><img class="imgslider" src="shareimg/<?php echo $argk['image']; ?>" alt="High Presssure Laminates (HPL), interior and Exterior Suppliers, Traders and Exporters in India" /></a>
						</div>
						<?php
						}
						?>
					...
					<div class="header-bottom catli" style="margin-top:0px;">
						...
						<ul class="nav ">
						 <?php 
                             $s="select * from category order by id desc limit 8,10";
