...
?>
    ...
    <div class="main-wrapper">
				...
				<div class="modal-dialog">
				  ...
				  <div class="modal-content">
					...
					<?php 
											...
											$m="select * from users order by id desc limit 1  ";
        ...
        <div class="col-xs-12 col-sm-12 col-md-6"> <img src="user/uploads/usersimage/<?php echo $ak['image'];?>"  class="img-popup"> </div>
        <div class="col-xs-12 col-sm-12 col-md-6">
          <div  class="margin-popup">
            <p  class="font-popup"><strong><?php echo $ak['key_word'];?></strong></p>
		...
		<form name="enquiry" method="post" action="sms.php">
          <div  class="margin-form">
            <p  class="font-form"><strong><?php echo $ak['company_name'];?></strong></p>
            <p ><img src="user/uploads/usersimage/<?php echo $ak['image'];?>"  class="img-popup-form"><strong><?php echo $ak['key_word'];?></strong></span> </p>
			<p><?php echo $ak['website'];?></p>
	  ...
	  <!-- Popup Stop Here--->
	        <div class="main-inner">
	            ...
	            <div class="content">
	                <div class="hero hero-background " >
						<div class="hero-content">
							...
							<div class="container containar-pop" >
								<div class="col-md-3 border2p" ><a href="#" data-toggle="modal" data-target="#myModal"><img  src="user/uploads/usersimage/<?php echo $ak['image'];?>" class="img-pop" ></a></div>
						...
						<ul class="nav nav-pills">
						 <?php 
                           ...
                           foreach ($ser as $k) {
                             ...
                             ?>  
							<li class="nav-item"><i class="fa fa-cogs  fa-2x category" aria-hidden="true" ></i><a href="#" class="nav-link"> <?php echo $k['cat_name'];?></a></li>
							<?php
						}
						?>
					...
					<div class="counter counter-margin" >
						<div class="container conheight" >
							<div class="row con-row" >
								...
								$total=$before+$totaluser;
										...
										?>
										<?php 
								$ma="SELECT city, count(*) as total FROM `users` GROUP BY `state` ";
								$mra=ExecuteQueryResule($ma);
								foreach ($mra as $aka) {
								$totalusera= $aka['total'];
								$beforea=10000;
