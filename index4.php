	            ...
	            <div class="content">
	              <div class="hero hero-background " >
					  <div class="container">
						...
						?>	
							<div class="row rowmain">
								<div class="col-md-3 marquebo"><a href="#" data-toggle="modal" data-target="#myModal"><img  src="offersimage/<?php echo $ak['image'];?>"  class="img-pop" alt="12345" title="adidas"></a></div>
