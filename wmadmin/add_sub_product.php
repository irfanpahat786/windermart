...
<script type="text/javascript">
...

	{
		...
		if(document.memberform.subproduct.value=="")

		{

			alert("Please Enter Sub Product Name");

			document.memberform.subproduct.focus();
...
<form name="memberform" id="memberform" action="web_sub_prod.php" method="post" enctype="multipart/form-data">
  ...
  <table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#03617C" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <th width="56%" height="25" align="left" valign="middle" bgcolor="#03617C" class="style2" scope="col"><a href="home.php" style="color: white;">HOME</a>&nbsp;&nbsp;&nbsp;&nbsp;Website Management >Sub Product</th>
        ...
        <tr>
          ...
          <th align="center" valign="top" scope="col" colspan="2"><table  width="100%">
            ...
            <tr>
              ...
              <td height="22" colspan="2" align="left" valign="middle" bgcolor="#FFFFD5" class="style777"><strong class="style10">Add Sub Product </strong></td>
			...
			<tr>
              ...
              <td width="471" height="22" colspan="1" align="left" valign="middle" class="style77">
			  			...
			  			<select class="form-control" name="prod_id" style=" border-radius: 10px; height:40px; width:50%; size:50px;">

							  <option value="">Select Product</option>

							  <?php 

									$q="select * from mainproduct  ";
									...
									$ar=ExecuteQueryResule($q);
									 ...
									 { 
										...
										$cat_name=htmlentities(addslashes(trim($ak['product'])));
			...
			<tr>
              ...
              <td height="22" align="left" valign="middle" class="style77">Sub  Product</td>

              <td height="22" colspan="1" align="left" valign="middle" class="style77">

			  	<input name="subproduct" type="text" class="style77" value="" size="51" placeholder="Type Your Category Name Here" style=" border-radius: 10px; height:40px; width:50%; size:50px;">	</td>
