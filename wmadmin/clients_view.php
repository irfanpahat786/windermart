...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999" bgcolor="#FFFFFF">
    ...
    <td valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <th width="45%" height="25" align="left" valign="middle" bgcolor="#999999" class="style2">&nbsp;&nbsp;Website Management > View Services </th>
        <th width="55%" align="left" valign="middle" bgcolor="#999999" class="style2"><strong>
     ...
     <td>&nbsp;</td>
      ...
      <tr>
        ...
        <th colspan="4" align="right" valign="top" class="style77" scope="col"><a href="clients_add.php"><font color="#FF0000">Add New Page
        </font></a>&nbsp;&nbsp;</th>
      </tr>
      <tr>
     <td>&nbsp;</td>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">             
          <tr>
		   <!-- <td width="15%" align="left" valign="middle" bgcolor="#999999" class="style10"> Image </td>-->
			<td width="19%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Agent Name</td>
			<td width="22%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Numbering</td>
			<td width="15%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Email</td>
			<td width="15%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Phone</td>
              <td width="15%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Address</td>
         ...
         <?php 
				...
				{
					$projectsid = $userRow['projectsid'];
					
					
					$catQry = "select * from projects where projectsid = '$projectsid'";
...
<!--			 <td align="left"><div style="margin:3px;">
			  ...
			  <img src="../productImage/thumb/<?php echo stripslashes($userRow['imgName'])?>" width="75" height="94" border="0"/>
			  <?php } else {?>
			  <img src="img/img_not_available.jpg" width="75" height="94" border="0"/>
			  <?php }?>
			  </div></td>-->
<td align="left"><div style="margin:1px;"><?php echo stripslashes($userRow['name'])?>
</div></td>
<td align="left"><span class="label label-info pull-center"><?php echo stripslashes($userRow['numbering'])?></span></td>
                
                <td align="left"><div style="margin:1px;"><?php echo stripslashes($userRow['email'])?>
</div></td>
                <td align="left"><div style="margin:1px;"><?php echo stripslashes($userRow['phone'])?>
                    <td align="left"><div style="margin:1px;"><?php echo stripslashes($userRow['address'])?>
</div></td>
</div></td>
                
                
                
<!--<td align="left"><span class="label label-info pull-center"><?php echo stripslashes($catRow['heading'])?></span></td>-->
<!--<td align="left"><a href="clients_status.php?clientsid=<?php echo $userRow['clientsid']?>&status=<?php echo $userRow['status']?>"><span class="label label-info pull-center"><?php echo stripslashes($userRow['status'])?></span></a></td>-->

<td>
<a href="clients_edit.php?clientsid=<?php echo stripslashes($userRow['clientsid']);?>" class="btn btn-danger btn-sm show-tooltip" title="Edit">Edit</a>&nbsp;|&nbsp;
<a class="btn btn-danger btn-sm show-tooltip" title="Delete" href="clients_delete_one.php?clientsid=<?php echo stripslashes($userRow['clientsid']);?>" onclick="return confirm('Are you sure?')">Delete</a>
</td>
            </tr>
