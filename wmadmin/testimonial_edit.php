...
$testimonialsid = (isset($_GET['testimonialsid']) and $_GET['testimonialsid'] != '' ) ?  $_GET['testimonialsid'] :  header("Location: testimonial_view.php?q=err");
			   ...
			   if ($_REQUEST['q']=='delimg')
			   {
				...
				$memberQuery = "update testimonials set imgName='' where testimonialsid='$testimonialsid'";
				...
				header("Location: testimonial_edit.php?testimonialsid=$testimonialsid");
			   }

$userQuery = "select * from testimonials where testimonialsid='$testimonialsid'";
$userQueryResult = $connectionObject->executeQuery($userQuery);
   if(!$userQueryResult)
	...
	$userRow = mysql_fetch_assoc($userQueryResult);
			$testimonialsid = $userRow['testimonialsid']; 			
...
<body>
<br>
<form name="memberform" action="testimonial_edit_inter.php" enctype="multipart/form-data" method="post" onSubmit="return validation();">
...
<tbody>
          ...
          <tr>
             ...
             <td  bgcolor="#FBFBFB">
			 <input type="hidden" name="testimonialsid" value="<?php echo stripslashes($userRow['testimonialsid'])?>" />
         ...
         <tr>
             ...
             <td  bgcolor="#FBFBFB"> <?php
			  ...
			  ?>
			  	...
			  	&nbsp;<span class="style11">[if you do not wanted to show this testimonial on home page please click on checkbox.]</span>
			  <?php
			  	}elseif($priority==0)
				{
			  ?>
			  	<input type="checkbox" name="priority">
			  	&nbsp;<span class="style11">[if you wanted to show this testimonial on home page please click on checkbox.]</span>
				<?php
			  	}
			  ?></td>
            </tr>
          ...
          <tr>
             ...
             <td  bgcolor="#FBFBFB"><span class="style777">
              <input name="ufile" type="file" class="style77" />
              <br />
			...
			<?php 
			 if ($userRow['imgName']!='')
			  {
			?>
			<img src="../testimonial_images/<?php echo stripslashes($userRow['imgName'])?>" width="120" height="150" border="0"/>
            <br />
<a href="testimonial_edit.php?q=delimg&testimonialsid=<?=$testimonialsid?>">Delete</a>
			<?php
			  }else
			  {
			?>
