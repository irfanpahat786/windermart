...
//echo $detail = (mysql_escape_string($_POST['newsContent']) != '') ? mysql_escape_string($_POST['newsContent']):'';
			 ...
			 $adminQuery = "insert into  clients set name = '$name',email = '$email',phone = '$phone', numbering = '$numbering', address = '$address',  createdate='".date("Y-m-d")."'	";
...
header("Location:  clients_view.php?q=add");
