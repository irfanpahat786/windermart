...
<form name="memberform" action="login_check.php" method="post" onsubmit="return validation();">
<table width="35%" border="1" align="center" bordercolor="#03617C" bgcolor="#FFFFFF">
  <tr>
    <td><table width="99%" height="99" border="0" align="center" bgcolor="#FFFFCC"  >
      ...
      <tr>
        <td height="33" colspan="2" class="style11" style=" height:3px"><?php 
...
?>
      ...
      <tr>
        ...
        <td width="59%" height="25" align="left" valign="top"><input name="loginname" type="text" class="style77"  id="loginname" /></td>
      </tr>
      <tr>
        <td height="25" align="left" valign="top" class="style10">Password</td>
        <td height="25" align="left" valign="top"><input name="password" type="password" class="style77" id="password" /></td>
      </tr>
      <tr>
        <td height="25" class="style10">&nbsp;</td>
        <td height="25"><input name="submit" type="submit" class="style10" style="font-size:10px" value="Admin Log in !" /></td>
      </tr>
