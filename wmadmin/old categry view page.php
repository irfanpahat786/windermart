...
<a class="btn btn-danger btn-sm show-tooltip" title="Delete" href="web_category_delete.php?categoryid=<?php 
echo stripslashes($categoryRow['categoryid']);?>" onClick="return deleteAlert(this);">Delete</a></div></td>
