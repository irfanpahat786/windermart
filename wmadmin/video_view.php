...
<table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999" bgcolor="#FFFFFF">
    ...
    <td valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
     ...
     <td>&nbsp;</td>
      ...
      <tr>
        <th colspan="4" align="right" valign="top" class="style77" scope="col"><a href="video_add.php"><font color="#FF0000">Add New Agent
        </font></a>&nbsp;&nbsp;</th>
      </tr>
      <tr>
     <td>&nbsp;</td>
      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">             
		  ...
		  <!--  <td width="15%" align="left" valign="middle" bgcolor="#999999" class="style10"> Image </td>-->
			<td width="20%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Agent Name</td>
            	<td width="25%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Email</td>
			<td width="10%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Numbering</td>
		
			<td width="25%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Phone Number</td>
			<td width="30%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Address</td>
			<!--<td width="15%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Phone</td>-->
            <td width="15%" height="22" align="center" valign="middle" bgcolor="#999999" class="style10">Action</td>
          </tr>
         <?php 
			...
			<!-- <td align="left"><div style="margin:3px;">
			  ...
			  <img src="../video_images/<?php //echo stripslashes($userRow['imgName'])?>" width="75" height="94" border="0"/>
			  <?php //} else {?>
			  <img src="img/img_not_available.jpg" width="75" height="94" border="0"/>
			  <?php //}?>
			  </div></td>-->
<td align="left" class="style10"><div style="margin:1px;"><?php echo stripslashes($userRow['name'])?>
</div></td>
<td align="left"class="style10"><span ><?php echo stripslashes($userRow['email'])?></span></td>
<td align="left"class="style10"><span ><?php echo stripslashes($userRow['numbering'])?></span></td>

<td align="left"class="style10"><span ><?php echo stripslashes($userRow['phone'])?></span></td>
<td align="left"class="style10"><span ><?php echo stripslashes($userRow['address'])?></span></td>
<!--<td align="left"class="style10"><a href="video_status.php?videoid=<?php //echo $userRow['videoid']?>&status=<?php //echo $userRow['status']?>"><span ><?php //echo stripslashes($userRow['status'])?></span></a></td>
-->
<td>
<a href="video_edit.php?videoid=<?php echo stripslashes($userRow['videoid']);?>" class="btn btn-danger btn-sm show-tooltip" title="Edit">Edit</a>&nbsp;|&nbsp;
<a class="btn btn-danger btn-sm show-tooltip" title="Delete" href="video_delete_one.php?videoid=<?php echo stripslashes($userRow['videoid']);?>" onClick="return checkfields(this);">Delete</a>
</td>
            </tr>
      ...
      <tr>
        <th colspan="4" align="right" valign="top" class="style77" scope="col"><a href="video_add.php"><font color="#FF0000">Add New Video
        </font></a>&nbsp;&nbsp;</th>
      </tr>
      <tr>
      <td>&nbsp;
