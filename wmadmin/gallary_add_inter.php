...
$userQuerySelect = "select heading from gallery where heading='$heading'";
...
{
     header("location: gallary_add.php?q=ext");
	 exit();

}else  
{
			 
			 $adminQuery = "insert into  gallery set heading = '$heading',Key_word = '$Key_word',Description = '$Description', numbering = '$numbering', priority = '$priority', status = 'active', imgName='$imgName', detail ='$detail',Add_title='$Add_title', createdate='".date("Y-m-d")."'	";
}
//echo $adminQuery;
//exit();
...
header("Location:  gallary_view.php?q=add");
