      ...
      <tr>
        <th height="22" colspan="2" class="style77" scope="col"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">header  id</td>
            <td height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10"> phone  </td>
             <td width="15%" height="22" align="center" valign="middle" bgcolor="#FFFFD5" class="style10">Email</td>
            <td width="15%" height="22" align="center" valign="middle" bgcolor="#FFFFD5" class="style10">Action</td>
          </tr>		 
          <?php 
			    $categoryQuery = "select * from header ";				
            ...
            <tr>
              ...
              <td width="21%" align="left" valign="top" class="style77"><div style="margin:1px;"><?php echo $categoryRow['phone']?></div></td>
              <td width="21%" align="left" valign="top" class="style77"><div style="margin:1px;"><?php echo $categoryRow['email'];?></div></td>
              <td align="center" valign="top" class="style77"><div style="margin:3px;"><a href="edit_header.php?id=<?php echo $categoryRow['id']?>">Edit</a></td>
            </tr>
          <tr>
