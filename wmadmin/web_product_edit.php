        ...
        <tr>
          <th align="center" valign="top" scope="col"><table  width="100%">
            ...
            <td height="22" align="left" valign="middle" class="style77">Phone</td>
             <td width="423" bgcolor="#FBFBFB"><input name="Add_title" type="text" style="width:300px;" id="Add_title" value="<?php echo $productRow['Add_title']; ?>" />
			</td>
          </tr>
                 <tr>
            <td height="22" align="left" valign="middle" class="style77">Location</td>
             <td width="423" bgcolor="#FBFBFB"><input name="Key_word" type="text" style="width:300px;" id="Key_word" value="<?php echo $productRow['Key_word']; ?>" />
			</td>
          </tr>
			<tr>
            ...
            <tr>
              ...
              <td height="22" colspan="2" align="left" valign="middle" class="style77"><input name="Description" type="text" class="style77" id="Description" value="<?php echo $productRow['Description'] ?>" size="70" /></td>
            </tr>
                <tr>
...
<tr>
             ...
             <td  bgcolor="#FBFBFB">
			 <input type="hidden" name="productid" value="<?php echo stripslashes($productRow['productid'])?>" />
			 <select name="status" class="style77">
              <option value="active" <?php if ($productRow['status']=="active") echo 'selected'?>>Active</option>
              <option value="inactive" <?php if ($productRow['status']=="inactive") echo 'selected'?>>Inactive</option>
            </select></td>
          </tr>
            <tr>
            ...
            <tr>
             ...
             <tr>
              ...
              <td width="194" align="center" valign="top" class="style77"><span class="style777"><img src="../productImage/small/<?php echo $productRow['imgName']?>" border="1" class="style8" width="120" height="70"/></span></td>
            </tr>
              ...
              <td width="194" align="center" valign="top" class="style77"><span class="style777"><img src="../productImage/small/<?php echo $productRow['imgName2']?>" border="1" class="style8" width="120" height="70"/></span></td>
            </tr>
                <tr>
              ...
              <td width="194" align="center" valign="top" class="style77"><span class="style777"><img src="../productImage/small/<?php echo $productRow['imgName3']?>" border="1" class="style8" width="120" height="70"/></span></td>
            </tr>
			    <tr>
