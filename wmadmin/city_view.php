...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999" bgcolor="#FFFFFF">
    ...
    <td valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
     ...
     <td>&nbsp;</td>
      ...
      <tr>
        <!--<th align="left" valign="top" class="style77" scope="col"><a href="city_all_delete.php" onclick="return confirm('Are you sure?')"><font color="#FF0000">Delete All City Page
        </font></a>&nbsp;&nbsp;</th>-->
        <th colspan="4" align="right" valign="top" class="style77" scope="col"><a href="city_add.php"><font color="#FF0000">Add New Hotel & Resort
        </font></a>&nbsp;&nbsp;</th>
      </tr>
      <tr>
     <td>&nbsp;</td>
      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">             
          <tr>
			...
			<td width="19%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Hotel/Resort Name</td>
         ...
         <?php 
            ...
            <tr>
			 <td align="left"><div style="margin:3px;">
			  ...
			  <img src="../docs/<?php echo stripslashes($userRow['imgName'])?>" width="75" height="94" border="0"/>
			  <?php } else {?>
...
<td align="left"><span class="label label-info pull-center"><?php echo stripslashes($userRow['cityid'])?></span></td>
<td align="left"><a href="city_status.php?cityid=<?php echo $userRow['cityid']?>&status=<?php echo $userRow['status']?>"><span class="label label-info pull-center"><?php echo stripslashes($userRow['status'])?></span></a></td>

<td>
<a href="city_edit.php?cityid=<?php echo stripslashes($userRow['cityid']);?>" class="btn btn-danger btn-sm show-tooltip" title="Edit">Edit</a>&nbsp;|&nbsp;
<a class="btn btn-danger btn-sm show-tooltip" title="Delete" href="city_delete_one.php?cityid=<?php echo stripslashes($userRow['cityid']);?>" onclick="return confirm('Are you sure?')">Delete</a>
</td>
            </tr>
