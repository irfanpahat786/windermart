...
<table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#03617C" bgcolor="#FFFFFF">
  <tr>
    <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
              <th width="56%" height="25" align="left" valign="middle" bgcolor="#03617C" class="style2" scope="col"><a href="home.php" style="color: white;">HOME</a>&nbsp;&nbsp;&nbsp;&nbsp;Website Management >Manage Package</th>
      ...
      <tr>
        <th height="22" colspan="2" class="style77" scope="col"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="22" colspan="4" align="right" valign="middle" ><a href="web_package_add.php" class="style10"><font color="#FF0000">Add New Package</font></a></td>
            </tr>      
          <tr>
			<!--<td height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Image </td>-->
            
            <td width="8%" height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Package Name</td>
            <td width="8%" height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Price(1 Year)</td>
            <td width="20%" height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Detail(1 Year)</td>
            <td width="8%" height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Price(3 Months)</td>
            <td width="20%" height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Detail(3 Months)</td>
            <td width="8%" height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Price(3 Year)</td>
            <td width="20%" height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Detail(3 Year)</td>
            <td width="8%" height="22" align="center" valign="middle" bgcolor="#FFFFD5" class="style10">Action</td>
          </tr>		 
          <?php 
			    $categoryQuery = "select * from package ";				
            ...
            <tr>
              ...
              <td  width="8%"  align="left"  class="style77"><div style="margin:1px;"><?php echo $categoryRow['price1']?></div></td>
              <td  width="20%" align="left"  class="style77"><div style="margin:1px;"><?php echo $categoryRow['detail1']?></div></td>
              <td  width="8%"  align="left"  class="style77"><div style="margin:1px;"><?php echo $categoryRow['price1']?></div></td>
              <td  width="20%" align="left"  class="style77"><div style="margin:1px;"><?php echo $categoryRow['detail1']?></div></td>
              <td  width="8%"  align="left"  class="style77"><div style="margin:1px;"><?php echo $categoryRow['price1']?></div></td>
              <td  width="20%" align="left"  class="style77"><div style="margin:1px;"><?php echo $categoryRow['detail1']?></div></td>
