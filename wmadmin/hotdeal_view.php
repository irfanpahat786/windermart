...
<table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999" bgcolor="#FFFFFF">
    ...
    <td valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
     ...
     <td>&nbsp;</td>
      ...
      <tr>
        <th colspan="4" align="right" valign="top" class="style77" scope="col"><a href="hotdeal_add.php"><font color="#FF0000">Add New Tour Package
        </font></a>&nbsp;&nbsp;</th>
      </tr>
      <tr>
     <td>&nbsp;</td>
      ...
      <tr>
		...
		<td width="19%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Heading</td>
		 ...
		 <td align="left"><div style="margin:3px;">
			  ...
			  <img src="../gallery_images/hotdeals/<?php echo stripslashes($userRow['imgName'])?>" width="75" height="94" border="0"/>
			  <?php } else {?>
...
<td align="left"class="style10"><span ><?php echo stripslashes($userRow['hotdealid'])?></span></td>
<td align="left"class="style10"><a href="hotdeal_status.php?hotdealid=<?php echo $userRow['hotdealid']?>&status=<?php echo $userRow['status']?>"><span ><?php echo stripslashes($userRow['status'])?></span></a></td>

<td>
<a href="hotdeal_edit.php?hotdealid=<?php echo stripslashes($userRow['hotdealid']);?>" class="btn btn-danger btn-sm show-tooltip" title="Edit">Edit</a>&nbsp;|&nbsp;
<a class="btn btn-danger btn-sm show-tooltip" title="Delete" href="hotdeal_delete_one.php?hotdealid=<?php echo stripslashes($userRow['hotdealid']);?>" onClick="return deleteAlert(this);">Delete</a>
</td>
            </tr>
		  ...
		  <script language="javascript">
			...
			{
				if(confirm("Are you really want to delete this Tour Package?"))
				return true;
				else
				return false;
			}
