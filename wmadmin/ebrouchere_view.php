...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#999999" bgcolor="#FFFFFF">
    ...
    <td valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
     ...
     <td>&nbsp;</td>
      ...
      <tr>
         <!--<th align="left" valign="top" class="style77" scope="col"><a href="payment_all_delete.php" onclick="return confirm('Are you sure?')"><font color="#FF0000">Delete All Payment List page
        </font></a>&nbsp;&nbsp;</th>-->
        <th colspan="4" align="right" valign="top" class="style77" scope="col"><a href="ebrouchure_add.php"><font color="#FF0000">Add New Page
        </font></a>&nbsp;&nbsp;</th>
      </tr>
      <tr>
     <td>&nbsp;</td>
      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">             
          <tr>
			...
			<!--<td width="15%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Project Name</td>-->
         ...
         <?php 
            ...
            <tr>
			 <!--<td align="left"><div style="margin:3px;">
			  <?php if ($userRow['nwsimg']!=''){?>
			  <img src="../ebrouchure_images/<?php echo stripslashes($userRow['imgName'])?>" width="75" height="94" border="0"/>
			  <?php } else {?>
			  <img src="../ebrouchure_images/<?php echo stripslashes($userRow['imgName'])?>" width="75" height="94" border="0"/>
			  <?php }?>
			  </div></td>-->
...
<td align="left"><a href="ebrouchure_status.php?ebrochureid=<?php echo $userRow['ebrochureid']?>&status=<?php echo $userRow['status']?>"><span class="label label-info pull-center"><?php echo stripslashes($userRow['status'])?></span></a></td>

<td>
<a href="ebrouchure_edit.php?ebrochureid=<?php echo stripslashes($userRow['ebrochureid']);?>" class="btn btn-danger btn-sm show-tooltip" title="Edit">Edit</a>&nbsp;|&nbsp;
<a class="btn btn-danger btn-sm show-tooltip" title="Delete" href="ebrouchure_delete_once.php?ebrochureid=<?php echo stripslashes($userRow['ebrochureid']);?>" onclick="return confirm('Are you sure?')">Delete</a>
</td>
            </tr>
