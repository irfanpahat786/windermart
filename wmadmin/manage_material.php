  ...
  <tr>
    <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <!--<td height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Image </td>-->
            ...
            <td height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Name name </td>
       ...
       ?>
        ...
        ?>
              ...
              <td width="42%" align="left" valign="top" class="style77"><div style="margin:1px;"><?php echo $categoryRow['id'];?></div></td>
              <td width="21%" align="left" valign="top" class="style77"><div style="margin:1px;"><?php echo $categoryRow['heading'];?></div></td>
              <td width="21%" align="left" valign="top" class="style77"><div style="margin:1px;"><?php echo $categoryRow['subheading'];?></div></td>

              
              <td width="21%" align="left" valign="top" class="style77"><div style="margin:1px;"><?php echo $categoryRow['image'];?></div></td>
              <td width="21%" align="left" valign="top" class="style77"><div style="margin:1px;"><?php echo $categoryRow['m-type'];?></div></td>
              <td width="21%" align="left" valign="top" class="style77"><div style="margin:1px;"><?php echo $categoryRow['name'];?></div></td>
              
              
              
              <td align="center" valign="top" class="style77"><div style="margin:3px;"><a href="edit_material.php?id=<?php echo $categoryRow['id']?>">Edit</a></td>
            </tr>
          <tr>
