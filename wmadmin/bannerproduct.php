...
<body>
<br>
<form name="memberform" id="memberform" action="adds_product_inter.php" method="post" enctype="multipart/form-data">
<table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#03617C" bgcolor="#FFFFFF">
<tr>
         <th width="56%" height="25" align="left" valign="middle" bgcolor="#03617C" class="style2" scope="col"><a href="home.php" style="color: white;">HOME</a>&nbsp;&nbsp;&nbsp;&nbsp;Website Management >Add New Advertisement Product</th>
      ...
      <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
						  ...
						  <select class="form-control" id="Adds" name="ad_id" style=" border-radius: 10px; height:40px; width:50%; size:50px;">
							...
							<?php
							  if(count($ar)>0)
								...
								{
								    echo '<option value="">Advertisement not available</option>';
								}
								?>
          ...
          <input name="file" type="file" class="style77" value="" size="51"  style="height:40px; border-radius: 10px;">     </td>
              ...
              <td width="471" height="22" colspan="1" align="left" valign="middle" class="style77">
          <input name="product_name" type="text" class="style77" value="" size="51"  style="height:40px; border-radius: 10px;">     </td>
            </tr>
