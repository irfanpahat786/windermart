...
//.........................For Paging..........................
	...
	$linkvariable = "";
	if($testimonial_Id != "")    //manufacturerid
	{
		$linkvariable .= "&testimonial_Id=$testimonial_Id";
	}
...
<body>
<br>
<table width="1000px" border="1" align="left" cellpadding="0" cellspacing="0" bordercolor="#999999" bgcolor="#FFFFFF">
    ...
    <td valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
     ...
     <td>&nbsp;</td>
      ...
      <tr>
        <th colspan="4" align="right" valign="top" class="style77" scope="col"><a href="testimonial_add.php"><font color="#FF0000">Add New Page
        </font></a>&nbsp;&nbsp;</th>
      </tr>
      <tr>
     <td>&nbsp;</td>
         ...
         <?php 
            ...
            <tr>
			 <td align="left"><div style="margin:3px;">
			  ...
			  <img src="../testimonial_images/<?php echo stripslashes($userRow['imgName'])?>" width="75" height="94" border="0"/>
			  <?php } else {?>
...
<td align="left"><span class="label label-info pull-center"><?php echo stripslashes($userRow['testimonialsid'])?></span></td>
<td align="left"><a href="testimonial_status.php?testimonialsid=<?php echo $userRow['testimonialsid']?>&status=<?php echo $userRow['status']?>"><span class="label label-info pull-center"><?php echo stripslashes($userRow['status'])?></span></a></td>

<td>
<a href="testimonial_edit.php?testimonialsid=<?php echo stripslashes($userRow['testimonialsid']);?>" class="btn btn-danger btn-sm show-tooltip" title="Edit">Edit</a>&nbsp;|&nbsp;
<a class="btn btn-danger btn-sm show-tooltip" title="Delete" href="testimonial_delete_one.php?testimonialsid=<?php echo stripslashes($userRow['testimonialsid']);?>" onClick="return checkfields(this);">Delete</a>
</td>
            </tr>
