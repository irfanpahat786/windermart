  ...
  <tr>
    <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <th><button onClick="goBack()"  style="background-color:#03617C;color: white;" >Go Back</button></th>
      </tr>
      ...
      <tr>
        <th height="22" colspan="2" class="style77" scope="col"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Slider Name</td>
            <td height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10"> Slider Image  </td>
          ...
          <?php 
            ...
            <tr>
              ...
              <td width="42%" align="left" valign="top" class="style77"><div style="margin:1px;"><?php echo $categoryRow['image']?></div></td>
              <td width="21%" align="left" valign="top" class="style77"><div style="margin:1px;"><img src="../assets/images/sliders/<?php echo $categoryRow['image']?>" style="height:100px; width:100px;"></div></td>
              
              <td align="center" valign="top" class="style77"><div style="margin:3px;"><a href="edit-slider.php?id=<?php echo $categoryRow['id']?>">Edit</a></td>
            </tr>
          <tr>
