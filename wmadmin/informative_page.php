...
$id = $_REQUEST['id'];
			   ...
			   if ($_REQUEST['q']=='delimg')
			   {
				...
				header("Location: informative_page.php?id=$id");
			   }
                ...
                <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td valign="top"><!--               start your coding here                 -->
                        <form action="informative_page_inter.php" method="post" name="addfrm" id="addfrm" onsubmit="return validate();" enctype="multipart/form-data" >
