...
$clientsid = (isset($_GET['clientsid']) and $_GET['clientsid'] != '' ) ?  $_GET['clientsid'] :  header("Location: clients_view.php?q=err");

$userQuery = "select * from clients where clientsid='$clientsid'";
...
<body>
<br>
<form name="memberform" action="clients_edit_inter.php" enctype="multipart/form-data" method="post" onSubmit="return validation();">
...
<tbody>
          ...
          <!--<tr>
             ...
             <td  bgcolor="#FBFBFB">
			 <input type="hidden" name="clientsid" value="<?php echo stripslashes($userRow['clientsid'])?>" />
         ...
         <td width="265" bgcolor="#FBFBFB">Select Property *</td>
             <td width="423" bgcolor="#FBFBFB"><select name="projectsid" class="style77" id="projectsid">
			  ...
			  $projectsid = $userRow['projectsid'];
				...
				{
			 ?>
             <option value="<?php echo $countryRow['projectsid']; ?>" <?php if($countryRow['projectsid']==$projectsid) echo "selected"; ?>><?php echo $countryRow['heading']; ?></option>
          ...
          <tr>
             <td  bgcolor="#FBFBFB">Agent Name</td>
             <td  bgcolor="#FBFBFB"><input name="name" type="text" value="<?php echo stripslashes($userRow['name']); ?>"></td>
            </tr>
        <input type="hidden" name="clientsid" value="<?php echo stripslashes($userRow['clientsid'])?>" />
         <tr>
             <td  bgcolor="#FBFBFB">Numbering</td>
             <td  bgcolor="#FBFBFB"><input type="text" name="numbering" value="<?php echo $userRow['numbering']; ?>" style="width:40px;"></td>
            </tr>
    
    
     <tr>
             <td  bgcolor="#FBFBFB">Email</td>
             <td  bgcolor="#FBFBFB"><input name="email" type="text" value="<?php echo stripslashes($userRow['email']); ?>"></td>
            </tr>
    
    <tr>
             <td  bgcolor="#FBFBFB">Phone</td>
             <td  bgcolor="#FBFBFB"><input name="phone" type="text" value="<?php echo stripslashes($userRow['phone']); ?>"></td>
            </tr>
      ...
      <tr>
             ...
             <tr><td bgcolor="#FBFBFB" colspan="2"> <?php
				...
				rte1.html ='<?php echo rteSafe(stripslashes($userRow['address']))?>';
          ...
          <!--<tr>
			...
			<?php 
			 if ($userRow['imgName']!='')
			  {
			?>
			<img src="docs/<?php echo stripslashes($userRow['imgName'])?>" width="120" height="150" border="0"/>
			<?php
			  }else
			  {
			?>
