	            ...
	            <div class="content">
	              <div class="heros hero-background " >
					...
					<div class="slider slider-mar1" >
						...
						<div>
							<a href="http://www.windermart.com/<?php echo $argk['url'];?>"><img class="imgslider" src="shareimg/<?php echo $argk['image']; ?>" alt="Business Directory India: Top Online Business Listing Site 2017" /></a>
						</div>
						<?php
						}
						?>
